...
class DebuggerCommandHandler:
    ...
    def OnAdd(self, msg, code):
        ...
        if doc is None:
            ...
            warnings.warn("There is no active window - no breakpoint can be added", stacklevel=1)
            return None
    ...
    def OnUpdateAddBreakpoints(self, cmdui):
        ...
        if doc is None or not isinstance(view, CScintillaEditInterface):
            ...
            cmdui.SetCheck(
                doc.MarkerAtLine(lineNo, pywin.framework.editor.color.coloreditor.MARKER_BREAKPOINT)
                != 0
            )
