...
class Grammar(Generic[_NodeT]):
    ...
    def parse(
        ...
        *,
        ...
        p = self._parser(
            self._pgen_grammar, error_recovery=error_recovery, start_nonterminal=start_symbol
        )
...
class PythonGrammar(Grammar):
    ...
    def __init__(self, version_info: PythonVersionInfo, bnf_text: str):
        super().__init__(
            bnf_text, tokenizer=self._tokenize_lines, parser=PythonParser, diff_parser=DiffParser
        )
