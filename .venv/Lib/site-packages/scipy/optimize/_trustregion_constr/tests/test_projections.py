...
from numpy.testing import TestCase, assert_array_almost_equal, assert_equal, assert_allclose
...
class TestProjections(TestCase):
    ...
    def test_nullspace_and_least_squares_sparse(self):
        A_dense = np.array(
            [[1, 2, 3, 4, 0, 5, 0, 7], [0, 8, 7, 0, 1, 5, 9, 0], [1, 0, 0, 0, 0, 1, 2, 3]]
        )
        At_dense = A_dense.T
        A = csc_array(A_dense)
        test_points = (
    ...
    def test_rowspace_sparse(self):
        ...
        for method in available_sparse_methods:
            ...
            for z in test_points:
                ...
                assert_equal(np.linalg.matrix_rank(A_dense), np.linalg.matrix_rank(A_ext))
