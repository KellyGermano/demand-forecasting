...
def find_root(f, init, /, *, args=(), tolerances=None, maxiter=None, callback=None):
    ...
    res = _chandrupatla(f, xl, xr, args=args, **tolerances, maxiter=maxiter, callback=_callback)
...
def bracket_root(f, xl0, xr0=None, *, xmin=None, xmax=None, factor=None, args=(), maxiter=1000):
...
def bracket_minimum(
    f, xm0, *, xl0=None, xr0=None, xmin=None, xmax=None, factor=None, args=(), maxiter=1000
):
    ...
    res = _bracket_minimum(
        f, xm0, xl0=xl0, xr0=xr0, xmin=xmin, xmax=xmax, factor=factor, args=args, maxiter=maxiter
    )
