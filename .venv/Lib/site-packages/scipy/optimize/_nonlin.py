...
class KrylovJacobian(Jacobian):
    ...
    def __init__(
        self, rdiff=None, method="lgmres", inner_maxiter=20, inner_M=None, outer_k=10, **kw
    ):
        ...
        valid_inner_params = [
            k for k in signature(self.method).parameters if k not in ("self", "args", "kwargs")
        ]
        ...
        for key, value in kw.items():
            ...
            if key[6:] not in valid_inner_params:
                ...
                inner_param_suggestions = get_close_matches(key[6:], valid_inner_params, n=1)
                if inner_param_suggestions:
                    suggestion_msg = f" Did you mean '" f"{inner_param_suggestions[0]}'?"
                else:
                    suggestion_msg = ""
                ...
                warnings.warn(
                    ...
                    " It will be ignored."
                    "Please check inner method documentation for valid options." + suggestion_msg,
                    stacklevel=3,
