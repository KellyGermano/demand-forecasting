...
from ._differentiable_functions import VectorFunction, LinearVectorFunction, IdentityVectorFunction
...
class LinearConstraint:
    ...
    def _input_validation(self):
        ...
        try:
            ...
            message = (
                "`lb`, `ub`, and `keep_feasible` must be broadcastable " "to shape `A.shape[0:1]`"
            )
            raise ValueError(message)
