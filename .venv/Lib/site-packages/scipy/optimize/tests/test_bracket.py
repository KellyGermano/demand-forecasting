...
class TestBracketRoot:
    ...
    def test_vectorization(self, shape, xp):
        ...
        def bracket_root_single(xl0, xr0, xmin, xmax, factor, p):
            return _bracket_root(
                self.f, xl0, xr0, xmin=xmin, xmax=xmax, factor=factor, args=(p,), maxiter=maxiter
            )
    ...
    def test_bug_fixes(self):
        ...
        xr0 = [-6.63108551, 4.27840947, -7.36968526, -0.78124372, 1.92201295, -1.48930123, 0.0, 0.0]
...
class TestBracketMinimum:
    ...
    def get_kwargs(self, *, xl0=None, xr0=None, factor=None, xmin=None, xmax=None, args=None):
    ...
    def test_nfev_expected(self, seed, use_xmin, other_side, xp):
        ...
        kwargs = self.get_kwargs(xl0=xl0, xr0=xr0, xmin=xmin, xmax=xmax, factor=factor, args=args)
    ...
    def test_flags(self, xp):
        ...
        result = _bracket_minimum(f, xm0, xl0=xl0, xr0=xr0, xmin=xmin, args=args, maxiter=3)
