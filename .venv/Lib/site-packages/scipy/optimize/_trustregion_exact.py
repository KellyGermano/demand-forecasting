...
class IterativeSubproblem(BaseQuadraticSubproblem):
    ...
    def _initial_values(self, tr_radius):
        ...
        lambda_ub = max(
            0,
            self.jac_mag / tr_radius + min(-self.hess_gershgorin_lb, self.hess_fro, self.hess_inf),
        )
        ...
        lambda_lb = max(
            ...
            self.jac_mag / tr_radius - min(self.hess_gershgorin_ub, self.hess_fro, self.hess_inf),
        )
