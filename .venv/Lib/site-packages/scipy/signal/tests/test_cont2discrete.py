import numpy as np
from scipy._lib._array_api import assert_array_almost_equal, assert_almost_equal, xp_assert_close
...
class TestC2D:
    ...
    def test_foh(self):
        ...
        cd_truth = cc
        dd_truth = np.array([[0.260262223725224], [0.297442541400256], [-0.144098411624840]])
        dt_requested = 0.5
...
class TestC2dLti:
    def test_c2d_ss(self):
        ...
        A_res = np.array(
            [[0.985136404135682, 0.004876671474795], [0.009753342949590, 0.965629718236502]]
        )
