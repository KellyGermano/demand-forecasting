...
def tanhsinh(
    ...
    *,
    ...
    (f, a, b, log, maxfun, maxlevel, minlevel, atol, rtol, args, preserve_shape, callback, xp) = (
        _tanhsinh_iv(
    ...
    with np.errstate(over="ignore", invalid="ignore", divide="ignore"):
        ...
        temp = eim._initialize(f, (c,), args, complex_ok=True, preserve_shape=preserve_shape, xp=xp)
    ...
    def pre_func_eval(work):
        ...
        work.h = h0 / 2**work.n
        xjc, wj = _get_pairs(
            work.n, h0, dtype=work.dtype, inclusive=(work.n == minlevel), xp=xp, work=work
        )
...
def _integral_bound(f, a, b, step, args, constants, xp):
    ...
    k = a + n_steps * step
    left, left_error, left_nfev = _direct(f, a, k, step, args, constants, xp, inclusive=False)
