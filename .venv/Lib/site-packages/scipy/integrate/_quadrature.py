...
def trapezoid(y, x=None, dx=1.0, axis=-1):
    ...
    try:
        ret = xp.sum(d * (y[tuple(slice1)] + y[tuple(slice2)]) / 2.0, axis=axis, dtype=result_dtype)
    except ValueError:
    ...
    if x is None:  # Even-spaced Simpson's rule.
        ...
        tmp = (
            ...
            * (
                ...
                * (
                    2.0
                    - np.true_divide(1.0, h0divh1, out=np.zeros_like(h0divh1), where=h0divh1 != 0)
                )
                + y[slice1]
                * (hsum * np.true_divide(hsum, hprod, out=np.zeros_like(hsum), where=hprod != 0))
...
_builtincoeffs = {
    ...
    9: (9, 89600, [2857, 15741, 1080, 19344, 5778, 5778, 19344, 1080, 15741, 2857], -4671, 394240),
    10: (
        5,
        299376,
