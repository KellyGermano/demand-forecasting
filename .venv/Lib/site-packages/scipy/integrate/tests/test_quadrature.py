...
class TestCumulative_trapezoid:
    ...
    def test_y_nd_x_1d(self):
        ...
        ys_expected = (
            ...
            np.array(
                [[[2.0, 3.0, 4.0, 5.0]], [[10.0, 11.0, 12.0, 13.0]], [[18.0, 19.0, 20.0, 21.0]]]
            ),
            np.array(
                [
...
class TestTrapezoid:
    ...
    def test_gh21908(self, xp):
        ...
        xp_assert_close(trapezoid(y, x=xp.asarray([0, 10.0, 20.0])[:, None], axis=0), out0)
...
class TestCumulativeSimpson:
    ...
    def _get_theoretical_diff_between_simps_and_cum_simps(self, y, x):
        ...
        sub_integrals_h2 = _cumulative_simpson_unequal_intervals(y[..., ::-1], d[..., ::-1])[
            ..., ::-1
        ]
