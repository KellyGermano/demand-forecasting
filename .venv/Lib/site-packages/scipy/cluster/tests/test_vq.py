...
# Global data
X = np.array(
    [[3.0, 3], [4, 3], [4, 2], [9, 2], [5, 1], [6, 2], [9, 4], [5, 2], [5, 4], [7, 4], [6, 5]]
)
...
class TestWhiten:
    ...
    @pytest.mark.skipif(SCIPY_ARRAY_API, reason="`np.matrix` unsupported in array API mode")
...
class TestKMeans:
    ...
    def test_kmeans_lost_cluster(self, xp):
        ...
        initk = xp.asarray(
            [[-1.8127404, -0.67128041], [2.04621601, 0.07401111], [-2.31149087, -0.05160469]]
        )
