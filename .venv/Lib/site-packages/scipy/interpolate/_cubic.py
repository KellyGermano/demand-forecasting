    ...
    def __init__(
        ...
        *,
        ...
        if y.shape[0] == 2:
            ...
            t[ind] = (f1[ind] * m[(x_ind + 1,) + y_ind] + f2[ind] * m[(x_ind + 2,) + y_ind]) / f12[
                ind
            ]
    ...
    def __init__(self, x, y, axis=0, bc_type="not-a-knot", extrapolate=None):
        ...
        if y.size == 0:
            ...
            if n == 3 and bc[0] == "not-a-knot" and bc[1] == "not-a-knot":
                ...
                m = b.shape[0]
                s = solve(
                    A, b.reshape(m, -1), overwrite_a=True, overwrite_b=True, check_finite=False
                ).reshape(b.shape)
                ...
                if bc_start == "periodic":
                    ...
                    if bc_end == "not-a-knot":
                        ...
                        d = x[-1] - x[-3]
                        b[-1] = (
                            dxr[-1] ** 2 * slope[-2] + (2 * d + dxr[-1]) * dxr[-2] * slope[-1]
                        ) / d
                    elif bc_end[0] == 1:
                        A[1, -1] = 1
                        A[-1, -2] = 0
        ...
        for bc in bc_type:
            if isinstance(bc, str):
                ...
                try:
                    ...
                    raise ValueError(
                        "A specified derivative value must be " "given in the form (order, value)."
                    ) from e
