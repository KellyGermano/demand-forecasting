...
class TestMMIOArray:
    ...
    def test_simple_rectangular_integer(self, typeval, dtype):
        self.check_exact(
            array([[1, 2, 3], [4, 5, 6]], dtype=dtype), (2, 3, 6, "array", typeval, "general")
        )
    ...
    def test_simple_symmetric_integer(self, typeval, dtype):
        self.check_exact(
            array([[1, 2], [2, 4]], dtype=dtype), (2, 2, 4, "array", typeval, "symmetric")
        )
    ...
    def test_gh13634_non_skew_symmetric_int(self):
        self.check_exact(
            array([[1, 2], [-2, 99]], dtype=np.int32), (2, 2, 4, "array", "integer", "general")
        )

    def test_gh13634_non_skew_symmetric_float(self):
        self.check(
            array([[1, 2], [-2, 99.0]], dtype=np.float32), (2, 2, 4, "array", "real", "general")
        )
...
class TestMMIOSparseCSR(TestMMIOArray):
    ...
    def test_simple_float(self):
        self.check(
            scipy.sparse.csr_array([[1, 2], [3, 4.0]]), (2, 2, 4, "coordinate", "real", "general")
        )

    def test_simple_complex(self):
        self.check(
            scipy.sparse.csr_array([[1, 2], [3, 4j]]), (2, 2, 4, "coordinate", "complex", "general")
        )
...
class TestMMIOCoordinate:
    ...
    def test_read_symmetric_pattern(self):
        ...
        self.check_read(
            _symmetric_pattern_example, a, (5, 5, 7, "coordinate", "pattern", "symmetric")
        )
