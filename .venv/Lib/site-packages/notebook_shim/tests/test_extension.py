...
@pytest.mark.parametrize(
    "jp_argv,trait_name,trait_value", list_test_params([("enable_mathjax", False)])
)
...
def test_EXTAPP_AND_SVAPP_SHIM_MSG(read_app_logs, extensionapp, jp_argv, trait_name, trait_value):
    log = read_app_logs()
    # Verify a shim warning appeared.
...
def test_NOT_EXTAPP_NBAPP_AND_SVAPP_SHIM_MSG(
    read_app_logs, extensionapp, jp_argv, trait_name, trait_value
):
    log = read_app_logs()
    # Verify a shim warning appeared.
...
@pytest.mark.parametrize(
    "jp_argv,trait_name,trait_value",
    list_test_params([("mathjax_config", "TEST"), ("mathjax_url", "TEST")]),
)
