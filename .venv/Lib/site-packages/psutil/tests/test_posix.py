...
class TestProcess(PsutilTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.pid = spawn_subproc([PYTHON_EXE, "-E", "-O"], stdin=subprocess.PIPE).pid
    ...
    def test_create_time(self):
        ...
        round_time_psutil_tstamp = datetime.datetime.fromtimestamp(round_time_psutil).strftime(
            "%H:%M:%S"
        )
    ...
    def test_nic_names(self):
        ...
        for nic in psutil.net_io_counters(pernic=True):
            for line in output.split():
                ...
                raise pytest.fail(f"couldn't find {nic} nic in 'ifconfig -a'" f" output\n{output}")
