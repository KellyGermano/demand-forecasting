...
if sys.version_info >= (3, 12):
    ...
    _SupportsBuffer: TypeAlias = (
        bytes | bytearray | memoryview | _array.array[Any] | mmap.mmap | NDArray[Any] | generic
    )
...
_DT64ItemT_co = TypeVar(
    "_DT64ItemT_co", bound=dt.date | int | None, default=dt.date | int | None, covariant=True
)
...
_ConvertibleToTD64: TypeAlias = (
    dt.timedelta | int | _CharLike_co | character | number | timedelta64 | np.bool | None
)
...
class dtype(Generic[_ScalarT_co], metaclass=_DTypeMeta):
    ...
    def descr(
        ...
        tuple[LiteralString, LiteralString] | tuple[LiteralString, LiteralString, _Shape]
    ]: ...
    @property
    def fields(
        self,
    ) -> MappingProxyType[LiteralString, tuple[dtype, int] | tuple[dtype, int, Any]] | None: ...
    @property
    def flags(self) -> int: ...
    @property
...
class _ArrayOrScalarCommon:
    ...
    def tofile(
        self, fid: StrOrBytesPath | _SupportsFileMethods, sep: str = ..., format: str = ...
    ) -> None: ...
    ...
    def argmax(
        self, /, axis: SupportsIndex, out: None = None, *, keepdims: builtins.bool = False
    ) -> Any: ...
    ...
    @overload  # out: None (default)
    def clip(
        self, /, min: ArrayLike, max: ArrayLike | None = None, out: None = None, **kwargs: Any
    ) -> NDArray[Any]: ...
    @overload
    def clip(
    ...
    @overload
    def clip(
        self, /, min: ArrayLike, max: ArrayLike | None = None, *, out: _ArrayT, **kwargs: Any
    ) -> _ArrayT: ...
    @overload
    ...
    @overload
    def compress(
        self, /, condition: _ArrayLikeInt_co, axis: SupportsIndex | None = None, out: None = None
    ) -> NDArray[Any]: ...
    @overload
    def compress(
    ...
    @overload
    def compress(
        self, /, condition: _ArrayLikeInt_co, axis: SupportsIndex | None = None, *, out: _ArrayT
    ) -> _ArrayT: ...
    @overload  # out: None (default)
    def cumprod(
        self, /, axis: SupportsIndex | None = None, dtype: DTypeLike | None = None, out: None = None
    ) -> NDArray[Any]: ...
    @overload  # out: ndarray
    def cumprod(
    ...
    @overload
    def cumprod(
        self, /, axis: SupportsIndex | None = None, dtype: DTypeLike | None = None, *, out: _ArrayT
    ) -> _ArrayT: ...
    @overload  # out: None (default)
    def cumsum(
        self, /, axis: SupportsIndex | None = None, dtype: DTypeLike | None = None, out: None = None
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DTypeT_co]):
    ...
    @overload  # (None)
    def reshape(
        self, shape: None, /, *, order: _OrderACF = "C", copy: builtins.bool | None = None
    ) -> Self: ...
    ...
    @overload
    def __iter__(
        self: ndarray[tuple[Never, Never, Never, Never, Never, Never, Never, Never, Never]], /
    ) -> Iterator[Any]: ...
    ...
    @overload
    def __truediv__(
        self: _ArrayFloat64_co, other: _ArrayLikeInt_co | _ArrayLike[floating[_64Bit]], /
    ) -> NDArray[float64]: ...
    @overload
    def __truediv__(
        self: NDArray[complex128], other: _ArrayLikeComplex128_co, /
...
class generic(_ArrayOrScalarCommon, Generic[_ItemT_co]):
    ...
    @overload
    def getfield(self, dtype: _DTypeLike[_ScalarT], offset: SupportsIndex = ...) -> _ScalarT: ...
    @overload
...
class timedelta64(_IntegralMixin, generic[_TD64ItemT_co], Generic[_TD64ItemT_co]):
    ...
    @overload
    def __init__(
        self: timedelta64[L[0]], value: L[0], format: _TimeUnitSpec[_IntTD64Unit] = ..., /
    ) -> None: ...
    @overload
    def __init__(
        self: timedelta64[int], value: _IntLike_co, format: _TimeUnitSpec[_IntTD64Unit] = ..., /
    ) -> None: ...
    @overload
    def __init__(
        self: timedelta64[int], value: dt.timedelta, format: _TimeUnitSpec[_IntTimeUnit], /
    ) -> None: ...
    @overload
    def __init__(
...
class datetime64(_RealMixin, generic[_DT64ItemT_co], Generic[_DT64ItemT_co]):
    ...
    @overload
    def __init__(
        self: datetime64[None], value: _NaTValue | None = ..., format: _TimeUnitSpec = ..., /
    ) -> None: ...
    @overload
    def __init__(
    ...
    @overload
    def __init__(
        self: datetime64[dt.date], value: _DT64Date, format: _TimeUnitSpec[_DateUnit] = ..., /
    ) -> None: ...
    @overload
    def __init__(
        self: datetime64[int],
...
class matrix(ndarray[_2DShapeT_co, _DTypeT_co]):
    ...
    def __getitem__(
        self,
        key: SupportsIndex | _ArrayLikeInt_co | tuple[SupportsIndex | _ArrayLikeInt_co, ...],
        /,
    ) -> Incomplete: ...
    @overload
    ...
    @overload
    def sum(
        self, axis: _ShapeLike | None = None, dtype: DTypeLike | None = None, *, out: _ArrayT
    ...
    @overload  # type: ignore[override]
    def std(
        self, axis: None = None, dtype: DTypeLike | None = None, out: None = None, ddof: float = 0
    ) -> Incomplete: ...
    @overload
    def std(
    ...
    @overload
    def std(
        self, axis: _ShapeLike | None, dtype: DTypeLike | None, out: _ArrayT, ddof: float = 0
    ) -> _ArrayT: ...
    @overload
