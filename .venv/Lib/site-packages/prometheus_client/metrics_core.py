...
class UnknownMetricFamily(Metric):
    ...
    def add_metric(
        ...
        """
        self.samples.append(
            Sample(self.name, dict(zip(self._labelnames, labels)), value, timestamp)
        )
...
class CounterMetricFamily(Metric):
    ...
    def add_metric(
        ...
        if created is not None:
            self.samples.append(
                Sample(
                    self.name + "_created", dict(zip(self._labelnames, labels)), created, timestamp
                )
            )
...
class SummaryMetricFamily(Metric):
    ...
    def add_metric(
        ...
        self.samples.append(
            Sample(
                self.name + "_count", dict(zip(self._labelnames, labels)), count_value, timestamp
            )
        )
        self.samples.append(
...
class HistogramMetricFamily(Metric):
    ...
    def add_metric(
        ...
        if float(buckets[0][0]) >= 0 and sum_value is not None:
            ...
            self.samples.append(
                Sample(
                    self.name + "_sum", dict(zip(self._labelnames, labels)), sum_value, timestamp
                )
            )
