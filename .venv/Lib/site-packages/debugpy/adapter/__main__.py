...
def _parse_argv(argv):
    ...
    parser.add_argument("--for-server", type=int, metavar="PORT", help=argparse.SUPPRESS)
    ...
    parser.add_argument("--access-token", type=str, help="access token expected from the server")
    ...
    parser.add_argument("--log-stderr", action="store_true", help="enable logging to stderr")
