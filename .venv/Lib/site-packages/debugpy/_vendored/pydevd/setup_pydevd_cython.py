    ...
    for version in ("38", "39"):
        ...
        for line in template_lines:
            if version == "38":
                ...
                line = line.replace(
                    "CALL_EvalFrameDefault", "CALL_EvalFrameDefault_39(tstate, frame_obj, exc)"
                )
...
""",
                ...
                c_file_contents = c_file_contents.replace("\r\n", "\n").replace("\r", "\n")
                c_file_contents = c_file_contents.replace(
                    r"_pydevd_frame_eval\\release_mem.h", "_pydevd_frame_eval/release_mem.h"
                )
                c_file_contents = c_file_contents.replace(
                ...
                c_file_contents = c_file_contents.replace(
                    r"_pydevd_bundle\\pydevd_cython.pxd", "_pydevd_bundle/pydevd_cython.pxd"
                )
                c_file_contents = c_file_contents.replace(
                    r"_pydevd_bundle\\pydevd_cython.pyx", "_pydevd_bundle/pydevd_cython.pyx"
                )
...
build_extension(
    "_pydevd_bundle", extension_name, target_pydevd_name, force_cython, extension_folder, True
)
