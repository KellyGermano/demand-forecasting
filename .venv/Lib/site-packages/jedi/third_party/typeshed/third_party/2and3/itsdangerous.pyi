...
_serializer = (
    Any  # must be an object that has "dumps" and "loads" attributes (e.g. the json module)
)
...
class BadTimeSignature(BadSignature):
    ...
    def __init__(
        self, message: str, payload: Optional[Any] = ..., date_signed: Optional[int] = ...
    ) -> None: ...
...
class JSONWebSignatureSerializer(Serializer):
    ...
    def make_signer(
        self, salt: Optional[Union[Text, bytes]] = ..., algorithm: SigningAlgorithm = ...
    ) -> Signer: ...
    def make_header(
