...
class BaseRequest:
    ...
    shallow: Any
    def __init__(
        self, environ: WSGIEnvironment, populate_request: bool = ..., shallow: bool = ...
    ) -> None: ...
    @property
...
class BaseResponse:
    ...
    @classmethod
    def force_type(
        cls: Type[_SelfT], response: object, environ: Optional[WSGIEnvironment] = ...
    ) -> _SelfT: ...
    @classmethod
    def from_app(
        cls: Type[_SelfT], app: Any, environ: WSGIEnvironment, buffered: bool = ...
    ) -> _SelfT: ...
    @overload
...
class ETagResponseMixin:
    ...
    def make_conditional(
        self, request_or_environ, accept_ranges: bool = ..., complete_length: Optional[Any] = ...
    ): ...
