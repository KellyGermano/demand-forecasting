...
class Type(google___protobuf___message___Message):
    ...
    def HasField(
        self, field_name: typing_extensions___Literal["source_context", b"source_context"]
    ) -> builtin___bool: ...
    def ClearField(
        self,
...
class Field(google___protobuf___message___Message):
    ...
    class _Kind(
        google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[Field.KindValue]
    ):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
    ...
    class _Cardinality(
        google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[Field.CardinalityValue]
    ):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
...
class Option(google___protobuf___message___Message):
    ...
    def ClearField(
        self, field_name: typing_extensions___Literal["name", b"name", "value", b"value"]
    ) -> None: ...
