...
class ImmutableListMixin(Generic[_V]):
    ...
    def sort(
        self, cmp: Optional[Any] = ..., key: Optional[Any] = ..., reverse: Optional[Any] = ...
    ) -> NoReturn: ...
...
class FileMultiDict(MultiDict[_K, _V]):
    def add_file(
        self, name, file, filename: Optional[Any] = ..., content_type: Optional[Any] = ...
    ): ...
...
class ETags(Container[str], Iterable[str]):
    ...
    def to_header(self): ...
    def __call__(
        self, etag: Optional[Any] = ..., data: Optional[Any] = ..., include_weak: bool = ...
    ): ...
    def __bool__(self): ...
    __nonzero__: Any
    def __iter__(self): ...
