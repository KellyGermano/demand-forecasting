...
create_flags["parallel"] = (
    ...
    "Include the config files for parallel " "computing apps (ipengine, ipcontroller, etc.)",
)
...
class ProfileCreate(BaseIPythonApplication):
    ...
    parallel = Bool(False, help="whether to include parallel computing config files").tag(
        config=True
    )
