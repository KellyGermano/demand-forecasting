...
class ListTB(TBTools):
    ...
    def _format_list(self, extracted_list: list[Any]) -> list[str]:
        ...
        for ind, (filename, lineno, name, line) in enumerate(extracted_list):
            ...
            item += theme_table[self._theme_name].format([(Token.NormalEm if em else Token, "\n")])
            if line:
                item += theme_table[self._theme_name].format(
                    [
...
class FormattedTB(VerboseTB, ListTB):
    ...
    def structured_traceback(
        ...
        if mode in self.verbose_modes:
            ...
            return VerboseTB.structured_traceback(self, etype, evalue, etb, tb_offset, context)
        elif mode == "Docs":
            # return DocTB
            return DocTB(
            ...
            return ListTB.structured_traceback(self, etype, evalue, etb, tb_offset, context)
...
class AutoFormattedTB(FormattedTB):
    ...
    def structured_traceback(
        ...
        if isinstance(etb, tuple):
            ...
            self.tb = etb
        return FormattedTB.structured_traceback(self, etype, evalue, etb, tb_offset, context)
