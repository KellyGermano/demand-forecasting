...
class LaTeXTool(SingletonConfigurable):
    ...
    preamble = Unicode(
        help="Additional preamble to use when generating LaTeX source " "for dvipng backend.",
    ).tag(config=True)


def latex_to_png(s: str, encode=False, backend=None, wrap=False, color="Black", scale=1.0):
