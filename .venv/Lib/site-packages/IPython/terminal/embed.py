...
class EmbeddedMagics(Magics):
    ...
    @magic_arguments.argument(
        "-i", "--instance", action="store_true", help="Kill instance instead of call location"
    )
    @magic_arguments.argument(
    ...
    def kill_embedded(self, parameter_s=""):
        ...
        if args.instance:
            ...
            if kill:
                ...
                print(
                    "This embedded IPython instance will not reactivate anymore " "once you exit."
                )
        else:
            if not args.yes:
                kill = ask_yes_no(
...
class InteractiveShellEmbed(TerminalInteractiveShell):
    ...
    def embedded_active(self):
        return (self._call_location_id not in InteractiveShellEmbed._inactive_locations) and (
            self._init_location_id not in InteractiveShellEmbed._inactive_locations
        )
        ...
        if (
            ...
            if module is None:
                ...
                try:
                    ...
                    warnings.warn(
                        "Failed to get module %s" % global_ns.get("__name__", "unknown module")
                    )
