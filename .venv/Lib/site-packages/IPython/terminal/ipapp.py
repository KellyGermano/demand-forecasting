...
class TerminalIPythonApp(BaseIPythonApplication, InteractiveShellApp):
    ...
    subcommands = dict(
        profile=("IPython.core.profileapp.ProfileApp", "Create and manage IPython profiles."),
        kernel=("ipykernel.kernelapp.IPKernelApp", "Start a kernel without an attached frontend."),
        locate=("IPython.terminal.ipapp.LocateIPythonApp", LocateIPythonApp.description),
        history=("IPython.core.historyapp.HistoryApp", "Manage the IPython history database."),
    )
    ...
    display_banner = Bool(True, help="Whether to display a banner upon starting IPython.").tag(
        config=True
    )
