...
class IPDoctestItem(pytest.Item):
    ...
    def repr_failure(  # type: ignore[override]
        ...
        failures: Optional[Sequence[Union[doctest.DocTestFailure, doctest.UnexpectedException]]] = (
            None
        )
...
def _setup_fixtures(doctest_item: IPDoctestItem) -> FixtureRequest:
    ...
    doctest_item._fixtureinfo = fm.getfixtureinfo(**kwargs)  # type: ignore[attr-defined]
