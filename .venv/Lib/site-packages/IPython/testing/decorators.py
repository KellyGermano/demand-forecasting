...
def skip(msg=None):
    ...
    if msg and not isinstance(msg, str):
        raise ValueError(
            "invalid object passed to `@skip` decorator, did you " "meant `@skip()` with brackets ?"
        )
...
skip_if_not_osx = skipif(not sys.platform.startswith("darwin"), "This test only runs under macOS")

_x11_skip_cond = sys.platform not in ("darwin", "win32") and os.environ.get("DISPLAY", "") == ""
