...
def superreload(module, reload=reload, old_objects=None, shell=None, import_from_tracker=None):
    ...
    for name, new_obj in list(module.__dict__.items()):
        ...
        if key not in old_objects:
            ...
            imports_froms = import_from_tracker.imports_froms if import_from_tracker else None
    ...
    def post_execute_hook(self):
        ...
        if self._reloader.enabled and self._reloader.autoload_obj:
            ...
            if (
                ...
                self._track_imports_from_code(self._last_execution_info.transformed_cell)
