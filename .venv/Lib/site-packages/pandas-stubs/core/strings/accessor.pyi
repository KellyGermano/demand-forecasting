...
class StringMethods(
    ...
    def cat(
        self,
        others: Series[str] | Index[str] | pd.DataFrame | npt.NDArray[np.str_] | list[str],
        sep: str | None = None,
        na_rep: str | None = None,
        join: AlignJoin = "left",
    ) -> _T_STR: ...
    ...
    def partition(self, sep: str = " ", expand: Literal[True] = True) -> _T_EXPANDING: ...
    ...
    def partition(self, sep: str = " ", *, expand: Literal[False]) -> _T_OBJECT: ...
    @overload  # expand=True
    def rpartition(self, sep: str = " ", expand: Literal[True] = True) -> _T_EXPANDING: ...
    @overload  # expand=False (positional argument)
    ...
    def extractall(self, pat: str | re.Pattern[str], flags: int = 0) -> pd.DataFrame: ...
