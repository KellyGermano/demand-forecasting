...
_DTBoolOpsReturnType = TypeVar("_DTBoolOpsReturnType", bound=Series[bool] | np_1darray[np.bool])

class _IsLeapYearProperty(Generic[_DTBoolOpsReturnType]):
    @property
    def is_leap_year(self) -> _DTBoolOpsReturnType: ...

class _DatetimeBoolOps(_IsLeapYearProperty[_DTBoolOpsReturnType], Generic[_DTBoolOpsReturnType]):
    @property
...
_DTTimestampTimedeltaReturnType = TypeVar(
    ...
    bound=Series | Series[Timestamp] | Series[Timedelta] | DatetimeIndex | TimedeltaIndex,
)
...
class _DatetimeRoundingMethods(Generic[_DTTimestampTimedeltaReturnType]):
    def round(
        ...
        nonexistent: (
            Literal["shift_forward", "shift_backward", "NaT", "raise"] | timedelta | Timedelta
        ) = ...,
    ) -> _DTTimestampTimedeltaReturnType: ...
    def floor(
        self,
...
_DTNormalizeReturnType = TypeVar("_DTNormalizeReturnType", Series[Timestamp], DatetimeIndex)
_DTStrKindReturnType = TypeVar("_DTStrKindReturnType", bound=Series[str] | Index)
_DTToPeriodReturnType = TypeVar("_DTToPeriodReturnType", bound=PeriodSeries | PeriodIndex)
...
class _DatetimeLikeNoTZMethods(
    ...
    def to_period(self, freq: str | BaseOffset | None = ...) -> _DTToPeriodReturnType: ...
    def tz_localize(
        self,
        tz: TimeZones,
...
_TDNoRoundingMethodReturnType = TypeVar("_TDNoRoundingMethodReturnType", bound=Series[int] | Index)
_TDTotalSecondsReturnType = TypeVar("_TDTotalSecondsReturnType", bound=Series[float] | Index)
...
_PeriodDTReturnTypes = TypeVar("_PeriodDTReturnTypes", bound=Series[Timestamp] | DatetimeIndex)
...
_PeriodDTAReturnTypes = TypeVar("_PeriodDTAReturnTypes", bound=DatetimeArray | DatetimeIndex)
...
class DatetimeIndexProperties(
    ...
    def to_pydatetime(self) -> np_1darray[np.object_]: ...
    def std(self, axis: int | None = ..., ddof: int = ..., skipna: bool = ...) -> Timedelta: ...
...
class _dtDescriptor(CombinedDatetimelikeProperties, Generic[S1]):
    ...
    @overload
    def __get__(self, instance: Series[Timestamp], owner: Any) -> TimestampProperties: ...
    @overload
    def __get__(self, instance: Series[Timedelta], owner: Any) -> TimedeltaProperties: ...
    @overload
    def __get__(self, instance: Series[S1], owner: Any) -> CombinedDatetimelikeProperties: ...
    def round(
        self,
        freq: str | BaseOffset | None,
        ambiguous: Literal["raise", "infer", "NaT"] | bool | np_ndarray_bool = ...,
