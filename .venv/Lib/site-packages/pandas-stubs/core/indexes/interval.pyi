...
_EdgesFloat: TypeAlias = Sequence[float] | npt.NDArray[np.float64] | pd.Series[float] | Index[float]
_EdgesTimestamp: TypeAlias = (
    Sequence[DatetimeLike] | npt.NDArray[np.datetime64] | pd.Series[pd.Timestamp] | pd.DatetimeIndex
)
...
class IntervalIndex(ExtensionIndex[IntervalT, np.object_], IntervalMixin):
    ...
    def __getitem__(
        self,
        idx: slice | np_ndarray_anyint | Sequence[int] | Index | MaskType | np_ndarray_bool,
    ) -> IntervalIndex[IntervalT]: ...
    @overload
    ...
    @overload  # type: ignore[override]
    def __gt__(self, other: IntervalT | IntervalIndex[IntervalT]) -> np_1darray[np.bool]: ...
    @overload
    def __gt__(  # pyright: ignore[reportIncompatibleMethodOverride]
        self, other: pd.Series[IntervalT]
    ) -> pd.Series[bool]: ...
    @overload  # type: ignore[override]
    def __ge__(self, other: IntervalT | IntervalIndex[IntervalT]) -> np_1darray[np.bool]: ...
    @overload
    def __ge__(  # pyright: ignore[reportIncompatibleMethodOverride]
        self, other: pd.Series[IntervalT]
    ) -> pd.Series[bool]: ...
    @overload  # type: ignore[override]
    def __le__(self, other: IntervalT | IntervalIndex[IntervalT]) -> np_1darray[np.bool]: ...
    @overload
    def __le__(  # pyright: ignore[reportIncompatibleMethodOverride]
        self, other: pd.Series[IntervalT]
    ) -> pd.Series[bool]: ...
    @overload  # type: ignore[override]
    def __lt__(self, other: IntervalT | IntervalIndex[IntervalT]) -> np_1darray[np.bool]: ...
    @overload
