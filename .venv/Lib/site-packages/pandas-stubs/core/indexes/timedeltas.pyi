...
class TimedeltaIndex(DatetimeTimedeltaMixin[Timedelta, np.timedelta64], TimedeltaIndexProperties):
    def __new__(
        cls,
        data: Sequence[dt.timedelta | Timedelta | np.timedelta64 | float] | AxesData = ...,
        freq: str | BaseOffset = ...,
        closed: object = ...,
        dtype: Literal["<m8[ns]"] = ...,
        copy: bool = ...,
