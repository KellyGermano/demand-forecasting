...
class Index(IndexOpsMixin[S1]):
    ...
    def __new__(
        cls,
        data: Sequence[complex | np.complexfloating] | IndexOpsMixin[complex] | np_ndarray_complex,
        *,
    ...
    __bool__ = ...
    def union(self, other: list[HashableT] | Self, sort: bool | None = None) -> Index: ...
    ...
    def get_indexer(self, target, method: ReindexMethod | None = ..., limit=..., tolerance=...): ...
    def reindex(
        self,
        target,
    ...
    @overload
    def append(self: Index[C2], other: Index[C2] | Sequence[Index[C2]]) -> Index[C2]: ...
    @overload
    ...
    def __add__(
        self: Index[int],
        other: bool | Sequence[bool] | np_ndarray_bool | np_ndarray_anyint | Index[bool],
    ) -> Index[int]: ...
    @overload
    def __add__(
        self: Index[int],
    ...
    @overload
    def __radd__(self: Index[T_COMPLEX], other: np_ndarray_complex) -> Index[complex]: ...
    @overload
    def __radd__(
        self: Index[_str],
        other: np_ndarray_bool | np_ndarray_anyint | np_ndarray_float | np_ndarray_complex,
    ...
    def __sub__(
        self: Index[int],
        other: int | Sequence[int] | np_ndarray_bool | np_ndarray_anyint | Index[bool] | Index[int],
    ) -> Index[int]: ...
    @overload
    def __sub__(
        self: Index[int],
    ...
    def __sub__(
        ...
        other: Just[complex] | Sequence[Just[complex]] | np_ndarray_complex | Index[complex],
    ) -> Index[complex]: ...
    @overload
    ...
    @overload
    def __mul__(self: Index[int] | Index[float], other: timedelta) -> TimedeltaIndex: ...
    @overload
    def __mul__(self, other: float | Sequence[float] | Index[int] | Index[float]) -> Self: ...
    def __rmul__(self, other: float | Sequence[float] | Index[int] | Index[float]) -> Self: ...
    def __floordiv__(self, other: float | Sequence[float] | Index[int] | Index[float]) -> Self: ...
    def __rfloordiv__(self, other: float | Sequence[float] | Index[int] | Index[float]) -> Self: ...
    def __truediv__(self, other: float | Sequence[float] | Index[int] | Index[float]) -> Self: ...
    def __rtruediv__(self, other: float | Sequence[float] | Index[int] | Index[float]) -> Self: ...
