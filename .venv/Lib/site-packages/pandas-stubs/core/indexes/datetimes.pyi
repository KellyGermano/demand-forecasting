...
class DatetimeIndex(DatetimeTimedeltaMixin[Timestamp, np.datetime64], DatetimeIndexProperties):
    def __new__(
        cls,
        data: AxesData,
        freq: Frequency = ...,
    ...
    def shift(self, periods: int = 1, freq: DateOffset | Timedelta | str | None = None) -> Self: ...
