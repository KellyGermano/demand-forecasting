...
_ListLikeS1: TypeAlias = ArrayLike | dict[_str, np.ndarray] | Sequence[S1] | IndexOpsMixin[S1]
...
class Series(IndexOpsMixin[S1], NDFrame):
    ...
    def __new__(
        cls,
        data: S1 | _ListLikeS1[S1] | dict[HashableT1, S1] | KeysView[S1] | ValuesView[S1],
        index: AxesData | None = ...,
        dtype: Dtype = ...,
        name: Hashable = ...,
        copy: bool = ...,
    ...
    def __new__(
        cls,
        data: (
            Scalar | _ListLike | Mapping[HashableT1, Any] | BaseGroupBy | NaTType | NAType | None
        ) = ...,
        index: AxesData | None = ...,
        dtype: Dtype = ...,
        name: Hashable = ...,
    ...
    @final
    def __array_ufunc__(self, ufunc: Callable, method: _str, *inputs: Any, **kwargs: Any): ...
    def __array__(self, dtype: _str | np.dtype = ..., copy: bool | None = ...) -> np_1darray: ...
    @property
    def axes(self) -> list: ...
    @final
    ...
    def __getitem__(
        self,
        idx: list[_str] | Index | Series[S1] | slice | MaskType | tuple[Hashable | slice, ...],
    ) -> Self: ...
    @overload
    ...
    def repeat(self, repeats: int | list[int], axis: AxisIndex | None = 0) -> Series[S1]: ...
    @property
    ...
    def cov(self, other: Series[S1], min_periods: int | None = None, ddof: int = 1) -> float: ...
    @overload
    ...
    def nlargest(self, n: int = 5, keep: NsmallestNlargestKeep = "first") -> Series[S1]: ...
    def nsmallest(self, n: int = 5, keep: NsmallestNlargestKeep = "first") -> Series[S1]: ...
    def swaplevel(self, i: Level = -2, j: Level = -1, copy: _bool = True) -> Series[S1]: ...
    ...
    @final
    def swapaxes(self, axis1: AxisIndex, axis2: AxisIndex, copy: _bool = ...) -> Series[S1]: ...
    @final
    ...
    def __add__(
        self: Series[int],
        other: (
            bool | Sequence[bool] | np_ndarray_bool | np_ndarray_anyint | Index[bool] | Series[bool]
        ),
    ) -> Series[int]: ...
    @overload
    def __add__(
    ...
    @overload
    def __add__(self: Series[T_COMPLEX], other: np_ndarray_complex) -> Series[complex]: ...
    @overload
    def __add__(
        self: Series[_str],
        other: np_ndarray_bool | np_ndarray_anyint | np_ndarray_float | np_ndarray_complex,
    ) -> Never: ...
    @overload
    def __add__(
        self: Series[_str],
    ...
    def __add__(
        ...
        other: datetime | np.datetime64 | np_ndarray_dt | DatetimeIndex | Series[Timestamp],
    ) -> Series[Timestamp]: ...
    @overload
    def __add__(
        self: Series[Timedelta],
        other: timedelta | np.timedelta64 | np_ndarray_td | TimedeltaIndex | Series[Timedelta],
    ) -> Series[Timedelta]: ...
    @overload
    ...
    @overload
    def __radd__(self: Series[Never], other: complex | _ListLike | Index | Series) -> Series: ...
    @overload
    ...
    @overload
    def __radd__(self: Series[T_COMPLEX], other: np_ndarray_complex) -> Series[complex]: ...
    @overload
    def __radd__(
        self: Series[_str],
        other: np_ndarray_bool | np_ndarray_anyint | np_ndarray_float | np_ndarray_complex,
    ...
    @overload
    def __floordiv__(self: Series[bool] | Series[complex], other: np_ndarray) -> Never: ...
    @overload
    def __floordiv__(
        self: Series[int],
        other: Just[int] | Sequence[Just[int]] | np_ndarray_anyint | Index[int] | Series[int],
    ) -> Series[int]: ...
    @overload
    def __floordiv__(
        self: Series[int],
        other: (
            Just[float] | Sequence[Just[float]] | np_ndarray_float | Index[float] | Series[float]
        ),
    ) -> Series[float]: ...
    @overload
    def __floordiv__(
    ...
    @overload
    def __rfloordiv__(self: Series[bool] | Series[complex], other: np_ndarray) -> Never: ...
    @overload
    def __rfloordiv__(
        self: Series[int],
        other: Just[int] | Sequence[Just[int]] | np_ndarray_anyint | Index[int] | Series[int],
    ...
    @overload
    def __mul__(self: Series[T_COMPLEX], other: np_ndarray_complex) -> Series[complex]: ...
    @overload
    def __mul__(
    ...
    @overload
    def __rmul__(self, other: Index[Never] | Series[Never]) -> Series: ...
    @overload
    def __rmul__(
        self: Series[bool],
        other: T_COMPLEX | Sequence[T_COMPLEX] | Index[T_COMPLEX] | Series[T_COMPLEX],
    ...
    @overload
    def __rmul__(self: Series[T_COMPLEX], other: np_ndarray_complex) -> Series[complex]: ...
    @overload
    def __rmul__(
        self: Series[bool] | Series[int] | Series[float],
        other: timedelta | np.timedelta64 | np_ndarray_td | TimedeltaIndex | Series[Timedelta],
    ...
    def __truediv__(
        self: Series[bool],
        other: Just[complex] | Sequence[Just[complex]] | Index[complex] | Series[complex],
    ) -> Series[complex]: ...
    @overload
    def __truediv__(
        self: Series[int],
    ...
    @overload
    def __truediv__(self: Series[T_COMPLEX], other: np_ndarray_complex) -> Series[complex]: ...
    @overload
    def __truediv__(
        self: Series[Timedelta],
        other: (
    ...
    @overload
    def __rtruediv__(self: Series[T_COMPLEX], other: np_ndarray_complex) -> Series[complex]: ...
    @overload
    def __rtruediv__(
        self: Series[Timedelta],
        other: np_ndarray_bool | np_ndarray_anyint | np_ndarray_float | np_ndarray_complex,
...
class IntervalSeries(_SeriesSubclassBase[Interval[_OrderableT], np.object_], Generic[_OrderableT]):
    @property
