...
class SeriesGroupBy(GroupBy[Series[S2]], Generic[S2, ByT]):
    ...
    @overload
    def transform(self, func: TransformReductionListType, *args, **kwargs) -> Series: ...
    def filter(self, func: Callable | str, dropna: bool = ..., *args, **kwargs) -> Series: ...
    ...
    def nlargest(self, n: int = 5, keep: NsmallestNlargestKeep = "first") -> Series[S2]: ...
    def nsmallest(self, n: int = 5, keep: NsmallestNlargestKeep = "first") -> Series[S2]: ...
...
class DataFrameGroupBy(GroupBy[DataFrame], Generic[ByT, _TT]):
    ...
    @overload
    def transform(self, func: TransformReductionListType, *args, **kwargs) -> DataFrame: ...
