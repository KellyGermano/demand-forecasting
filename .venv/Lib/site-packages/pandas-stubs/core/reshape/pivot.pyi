...
_PivotTableIndexTypes: TypeAlias = Label | Sequence[HashableT1] | Series | Grouper | None
_PivotTableColumnsTypes: TypeAlias = Label | Sequence[HashableT2] | Series | Grouper | None
...
def pivot_table(
    ...
    aggfunc: _PivotAggFunc | Sequence[_PivotAggFunc] | Mapping[Hashable, _PivotAggFunc] = ...,
