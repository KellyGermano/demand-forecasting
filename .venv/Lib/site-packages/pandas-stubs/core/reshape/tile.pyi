...
def cut(  # pyright: ignore[reportOverlappingOverload]
    x: Series[Timestamp],
    bins: int | Series[Timestamp] | DatetimeIndex | Sequence[Timestamp] | Sequence[np.datetime64],
    right: bool = ...,
...
def cut(
    x: Index | npt.NDArray | Sequence[int] | Sequence[float],
    bins: (
        int | Series | Index[int] | Index[float] | Sequence[int] | Sequence[float] | IntervalIndex
    ),
    right: bool = ...,
    *,
    labels: Literal[False],
