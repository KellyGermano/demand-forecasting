...
class _iLocIndexerFrame(_iLocIndexer, Generic[_T]):
    ...
    def __getitem__(
        self,
        idx: (
            IndexType | MaskType | tuple[IndexType | MaskType, IndexType | MaskType] | tuple[slice]
        ),
    ) -> _T: ...
    def __setitem__(
        self,
...
class _LocIndexerFrame(_LocIndexer, Generic[_T]):
    ...
    def __getitem__(  # type: ignore[overload-overlap] # pyright: ignore[reportOverlappingOverload]
        self,
        idx: tuple[
            int | StrLike | Timestamp | tuple[Scalar, ...] | Callable[[DataFrame], ScalarT],
    ...
    def __setitem__(
        self,
        idx: MaskType | StrLike | _IndexSliceTuple | list[ScalarT] | IndexingInt | slice,
        value: (
            Scalar
            | NAType
            | NaTType
...
class DataFrame(NDFrame, OpsMixin, _GetItemHack):
    ...
    @overload
    def itertuples(self, index: _bool = ..., name: _str = ...) -> Iterator[_PandasNamedTuple]: ...
    @overload
    def itertuples(self, index: _bool = ..., name: None = None) -> Iterator[tuple[Any, ...]]: ...
    ...
    def to_records(
        self,
        index: _bool = True,
        column_dtypes: _str | npt.DTypeLike | Mapping[HashableT1, npt.DTypeLike] | None = None,
        index_dtypes: _str | npt.DTypeLike | Mapping[HashableT2, npt.DTypeLike] | None = None,
    ) -> np.recarray: ...
    @overload
    def to_stata(
        self,
    ...
    def to_feather(self, path: FilePath | WriteBuffer[bytes], **kwargs: Any) -> None: ...
    @overload
    def to_parquet(
        self,
        path: FilePath | WriteBuffer[bytes],
    ...
    def isetitem(self, loc: int | Sequence[int], value: Scalar | ArrayLike | list[Any]) -> None: ...
    ...
    @overload
    def select_dtypes(self, include: _AstypeArgExtList | None, exclude: StrDtypeArg) -> Never: ...
    @overload
    ...
    def set_index(
        self,
        keys: Label | Series | Index | np.ndarray | Iterator[Hashable] | Sequence[Hashable],
        *,
        drop: _bool = ...,
        append: _bool = ...,
    ...
    def explode(self, column: Sequence[Hashable], ignore_index: _bool = False) -> Self: ...
    def unstack(
        self,
        level: IndexLabel = -1,
        fill_value: Scalar | None = None,
    ...
    def round(self, decimals: int | dict | Series = ..., *args: Any, **kwargs: Any) -> Self: ...
    def corr(
        self,
