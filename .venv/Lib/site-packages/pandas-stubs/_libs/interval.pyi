...
class Interval(IntervalMixin, Generic[_OrderableT]):
    ...
    @overload
    def __add__(self: Interval[int], y: _OrderableScalarT) -> Interval[_OrderableScalarT]: ...
    @overload
    ...
    @overload
    def __radd__(self: Interval[int], y: _OrderableScalarT) -> Interval[_OrderableScalarT]: ...
    @overload
    ...
    @overload
    def __sub__(self: Interval[int], y: _OrderableScalarT) -> Interval[_OrderableScalarT]: ...
    @overload
    ...
    @overload
    def __rsub__(self: Interval[int], y: _OrderableScalarT) -> Interval[_OrderableScalarT]: ...
    @overload
    def __rsub__(self: Interval[float], y: float) -> Interval[float]: ...
    @overload
    def __mul__(self: Interval[int], y: _OrderableScalarT) -> Interval[_OrderableScalarT]: ...
    @overload
    def __mul__(self: Interval[float], y: float) -> Interval[float]: ...
    @overload
    def __mul__(self: Interval[Timedelta], y: float) -> Interval[Timedelta]: ...
    @overload
    def __rmul__(self: Interval[int], y: _OrderableScalarT) -> Interval[_OrderableScalarT]: ...
    @overload
    ...
    @overload
    def __floordiv__(self: Interval[int], y: _OrderableScalarT) -> Interval[_OrderableScalarT]: ...
    @overload
    ...
    @overload
    def __gt__(self: IntervalT, other: IntervalIndex[IntervalT]) -> np_1darray[np.bool]: ...
    @overload
    def __gt__(
        self,
    ...
    @overload
    def __lt__(self: IntervalT, other: IntervalIndex[IntervalT]) -> np_1darray[np.bool]: ...
    @overload
    def __lt__(
        self,
        other: Series[int] | Series[float] | Series[Timestamp] | Series[Timedelta],
    ...
    @overload
    def __ge__(self: IntervalT, other: IntervalIndex[IntervalT]) -> np_1darray[np.bool]: ...
    @overload
    def __ge__(
        self,
        other: Series[int] | Series[float] | Series[Timestamp] | Series[Timedelta],
    ...
    @overload
    def __le__(self: IntervalT, other: IntervalIndex[IntervalT]) -> np_1darray[np.bool]: ...
    @overload
    def __eq__(self, other: Interval[_OrderableT]) -> bool: ...  # type: ignore[overload-overlap] # pyright: ignore[reportOverlappingOverload]
    @overload
    def __eq__(self: IntervalT, other: IntervalIndex[IntervalT]) -> np_1darray[np.bool]: ...
    @overload
    ...
    @overload
    def __ne__(self: IntervalT, other: IntervalIndex[IntervalT]) -> np_1darray[np.bool]: ...
    @overload
