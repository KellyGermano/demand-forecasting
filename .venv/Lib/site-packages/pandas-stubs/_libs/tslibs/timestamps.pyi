...
class Timestamp(datetime, SupportsIndex):
    ...
    @overload
    def __le__(self, other: np_ndarray[ShapeT, np.datetime64]) -> np_ndarray[ShapeT, np.bool]: ...
    @overload
    ...
    @overload
    def __lt__(self, other: np_ndarray[ShapeT, np.datetime64]) -> np_ndarray[ShapeT, np.bool]: ...
    @overload
    ...
    @overload
    def __ge__(self, other: np_ndarray[ShapeT, np.datetime64]) -> np_ndarray[ShapeT, np.bool]: ...
    @overload
    ...
    @overload
    def __gt__(self, other: np_ndarray[ShapeT, np.datetime64]) -> np_ndarray[ShapeT, np.bool]: ...
    @overload
