...
class Period(PeriodMixin):
    def __init__(
        self,
        value: Period | str | datetime.datetime | datetime.date | Timestamp | None = ...,
    ...
    @overload
    def __ge__(self, other: np_ndarray[ShapeT, np.object_]) -> np_ndarray[ShapeT, np.bool]: ...
    @overload
    ...
    @overload
    def __gt__(self, other: np_ndarray[ShapeT, np.object_]) -> np_ndarray[ShapeT, np.bool]: ...
    @overload
    ...
    @overload
    def __le__(self, other: np_ndarray[ShapeT, np.object_]) -> np_ndarray[ShapeT, np.bool]: ...
    @overload
    ...
    @overload
    def __lt__(self, other: np_ndarray[ShapeT, np.object_]) -> np_ndarray[ShapeT, np.bool]: ...
    #  ignore[misc] here because we know all other comparisons
    #  are False, so we use Literal[False]
    @overload
