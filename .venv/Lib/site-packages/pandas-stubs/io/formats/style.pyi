...
class Styler(StylerRenderer):
    ...
    def to_latex(
        ...
        *,
        ...
        hrules: bool | None = ...,
        clines: Literal["all;data", "all;index", "skip-last;data", "skip-last;index"] | None = ...,
        label: str | None = ...,
        caption: str | tuple[str, str] | None = ...,
    ...
    def background_gradient(
        ...
        gmap: (
            Sequence[float] | Sequence[Sequence[float]] | npt.NDArray | DataFrame | Series | None
        ) = None,
    ) -> Styler: ...
    def text_gradient(
        self,
    ...
    def set_properties(self, subset: Subset | None = ..., **kwargs: str | int) -> Styler: ...
    def bar(
        self,
        subset: Subset | None = None,
        axis: Axis | None = 0,
