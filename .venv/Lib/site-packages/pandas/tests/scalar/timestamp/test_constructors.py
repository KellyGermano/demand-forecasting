...
class TestTimestampClassMethodConstructors:
    ...
    def test_now(self):
        ...
        assert (
            abs(ts_from_string_tz.tz_localize(None) - ts_from_method_tz.tz_localize(None)) < delta
        )
...
class TestTimestampConstructors:
    ...
    def test_constructor_invalid_tz(self):
        # GH#17690
        msg = "Argument 'tzinfo' has incorrect type " r"\(expected datetime.tzinfo, got str\)"
        with pytest.raises(TypeError, match=msg):
