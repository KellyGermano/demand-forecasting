...
class TestPeriodConstruction:
    ...
    def test_period_constructor_offsets(self):
        ...
        assert Period(year=2005, quarter=1, freq=offsets.QuarterEnd(startingMonth=12)) == Period(
            year=2005, quarter=1, freq="Q"
        )
        assert Period(year=2005, quarter=2, freq=offsets.QuarterEnd(startingMonth=12)) == Period(
            year=2005, quarter=2, freq="Q"
        )
...
class TestPeriodProperties:
    ...
    def test_properties_secondly(self):
        ...
        assert (
            Period(freq="Min", year=2012, month=2, day=1, hour=0, minute=0, second=0).days_in_month
            == 29
        )
