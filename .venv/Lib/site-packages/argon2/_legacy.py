...
def hash_password(
    ...
    """
    warnings.warn("argon2.hash_password" + _INSTEAD, DeprecationWarning, stacklevel=2)
    if salt is None:
...
def verify_password(hash: bytes, password: bytes, type: Type = Type.I) -> Literal[True]:
    ...
    .. deprecated:: 16.0.0
        Use :class:`argon2.PasswordHasher` for passwords.
    """
    warnings.warn("argon2.verify_password" + _INSTEAD, DeprecationWarning, stacklevel=2)
