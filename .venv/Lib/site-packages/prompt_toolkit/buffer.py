...
class Buffer:
    ...
    def __init__(
        ...
        self._document_cache: FastDictCache[tuple[str, int, SelectionState | None], Document] = (
    ...
    def delete(self, count: int = 1) -> str:
        ...
        if self.cursor_position < len(self.text):
            ...
            self.text = (
                self.text[: self.cursor_position] + self.text[self.cursor_position + len(deleted) :]
            )
            return deleted
        else:
            return ""
